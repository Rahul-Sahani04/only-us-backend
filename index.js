...
io.on("connection", (socket) => {
  ...
  socket.on(
    ...
    async ({ authToken, current_connection }) => {
      // Call the /makeFriend endpoint using fetch or axios

      const response = await fetch(api + "/api/auth/makeFriend", {
        method: "POST",
        headers: {
  ...
  socket.on("update", async ({ socketId, authToken }) => {
    ...
    const response = await fetch(api + "/api/auth/reactionUpdate", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-Token": authToken,
  ...
  socket.on("joined", async ({ user, authToken }) => {
    ...
    const response = await fetch(api + "/api/auth/updateOnlinestatus", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-Token": authToken,
  ...
  socket.on("findUser", async (authToken) => {
    const response = await fetch(api + "/api/auth/findFreeuser", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-Token": authToken,
    ...
    if (data.usersAvailables !== false) {
      ...
      socket.emit("welcome", {
        user: "User",
        message: "Another Homosapien is here! Please Feel Free to talk",
      });
      io.to(data.socketId).emit("welcome", {
        user: "User",
        message: "Another Homosapien is here! Please Feel Free to talk",
      });
    }
  ...
  socket.on("disconnect", async () => {
    ...
    const response = await fetch(api + "/api/auth/updateDisconnect", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
